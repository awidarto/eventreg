...
<div style="width:100%;position:relative;display:block;font-family:Helvetica,Arial,Sans-serif;font-size:13px;">
	...
	<div style="width:100%;position:relative;display:block;margin-top:25px;">
	<p style="margin:10px 0;">Dear THE 37TH IPA CONVENTION AND EXHIBITION 2013 Exhibitor,</p>

	<p style="margin:10px 0;line-height:25px;">Thank you for submitting the operational forms.<br/>

	Hereby (attached) is the summary for your facilities requirement.<br/>

...
Route::controller(array('register','exhibition','report','booth','boothassistant','import','export','dashboard','onsite','cashier','reader','attendee','exhibitor','official','visitor','user','message','search','activity','category','content','ajax'));
